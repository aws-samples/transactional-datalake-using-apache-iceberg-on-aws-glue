...
class AuroraMysqlStack(Stack):
  ...
  def __init__(self, scope: Construct, id: str, vpc, **kwargs) -> None:
    ...
    cdk.Tags.of(self.sg_mysql_client).add('Name', 'default-mysql-client-sg')
    ...
    cdk.CfnOutput(self, 'DBClusterEndpoint', value=db_cluster.cluster_endpoint.socket_address, export_name=f'{self.stack_name}-DBClusterEndpoint')
    cdk.CfnOutput(self, 'DBClusterReadEndpoint', value=db_cluster.cluster_read_endpoint.socket_address, export_name=f'{self.stack_name}-DBClusterReadEndpoint')
